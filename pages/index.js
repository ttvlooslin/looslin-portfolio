...
export default function LooslinPortfolio() {
  ...
  const links = [
    { title: 'Twitch', description: 'Watch me stream live', url: 'https://twitch.tv/looslin', icon: Twitch, color: 'from-blue-500 to-cyan-500' },
    { title: 'Spotify', description: 'Listen to my music', url: 'https://open.spotify.com/artist/0c1QcII1IRyx3V3oXwgnPf?si=yQg0sVnbSRWC8oZYAKWCgQ', icon: Music, color: 'from-red-500 to-pink-500' },
    { title: 'Sports Cards', description: 'Check my collection', url: 'https://ebay.io/m/4UYJ4f', icon: BarChart3, color: 'from-orange-500 to-red-500' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <section id="home" className="max-w-6xl mx-auto px-6 py-24 sm:py-32 text-center">
          <div className="space-y-8">
            ...
            <h2 className="text-6xl sm:text-7xl font-black"><span className="bg-gradient-to-r from-blue-400 via-red-400 to-cyan-400 bg-clip-text text-transparent">LOOSLIN</span></h2>
        ...
        <section id="about" className="max-w-6xl mx-auto px-6 py-20">
          <div className="backdrop-blur-sm bg-white/5 border border-white/10 rounded-2xl p-8 sm:p-12 hover:border-blue-500/50 transition-all duration-500">
            ...
            <div className="space-y-4 text-gray-200 leading-relaxed text-lg">
              <p>From a young age, Laughlin McKinnon fell in love with sports. That same passion for collection led him to sports cards, turning hobby into obsession, filling binders with treasures and memories.</p>
              <p>Through high school, his taste in music evolved and expanded. Then came creating his own music. Laughlin started producing, writing, and sharing tracks that blend his unique influences into something authentically his own.</p>
              <p>With an undeniable talent for gaming and a natural ability to entertain, Looslin realized what he was meant to do—stream everything live. Every game session, every creative moment became shareable content for an ever-growing community.</p>
              <p className="text-transparent bg-gradient-to-r from-blue-300 to-red-300 bg-clip-text font-bold text-xl">If you're looking for genuine energy, raw talent, and relatable entertainment—you found the GOAT. Hit that follow button and let's build this community together.</p>
            </div>
          </div>
        </section>
        <section className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group relative overflow-hidden rounded-2xl backdrop-blur-sm bg-white/5 border border-white/10 hover:border-cyan-500/50 transition-all duration-500">
              <video src="/images/studio-3.mp4" controls className="w-full h-80 object-cover bg-black" />
        ...
        <section className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div className="group relative overflow-hidden rounded-lg bg-white/5 border border-white/10 hover:border-orange-500/50 aspect-square">
              <img src="/images/card-1.jpg" alt="Card 1" className="w-full h-full object-cover group-hover:scale-110 transition-transform" />
            </div>
            <div className="group relative overflow-hidden rounded-lg bg-white/5 border border-white/10 hover:border-orange-500/50 aspect-square">
              <img src="/images/card-2.jpg" alt="Card 2" className="w-full h-full object-cover group-hover:scale-110 transition-transform" />
            </div>
            <div className="group relative overflow-hidden rounded-lg bg-white/5 border border-white/10 hover:border-orange-500/50 aspect-square">
              <img src="/images/card-3.jpg" alt="Card 3" className="w-full h-full object-cover group-hover:scale-110 transition-transform" />
            </div>
            <div className="group relative overflow-hidden rounded-lg bg-white/5 border border-white/10 hover:border-orange-500/50 aspect-square">
              <img src="/images/card-4.jpg" alt="Card 4" className="w-full h-full object-cover group-hover:scale-110 transition-transform" />
            </div>
            <div className="group relative overflow-hidden rounded-lg bg-white/5 border border-white/10 hover:border-orange-500/50 aspect-square">
              <img src="/images/card-5.jpg" alt="Card 5" className="w-full h-full object-cover group-hover:scale-110 transition-transform" />
            </div>
            <div className="group relative overflow-hidden rounded-lg bg-white/5 border border-white/10 aspect-square bg-gradient-to-br from-blue-500/20 to-red-500/20 flex items-center justify-center">
            ...
            <div className="group relative overflow-hidden rounded-lg bg-white/5 border border-white/10 aspect-square bg-gradient-to-br from-blue-500/20 to-red-500/20 flex items-center justify-center">
              <p className="text-center text-gray-300 font-bold">Grows</p>
            </div>
          </div>
        </section>
        <section id="links" className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {links.map((link,idx)=>{const Icon=link.icon;return(<a key={idx} href={link.url} target="_blank" rel="noopener noreferrer" className="group relative overflow-hidden rounded-xl backdrop-blur-sm bg-white/5 border border-white/10 p-8 hover:border-white/30 transition-all duration-500"><div className="relative z-10 space-y-4"><div className={`inline-block p-3 rounded-lg bg-gradient-to-br ${link.color} group-hover:scale-110 transition-transform`}><Icon size={24}/></div><h4 className="text-xl font-bold">{link.title}</h4><p className="text-gray-300 text-sm">{link.description}</p><div className="flex items-center gap-2 text-sm text-blue-300 group-hover:text-blue-200 transition-colors">Visit<ExternalLink size={16}/></div></div></a>);})}
          </div>
        ...
        <section id="contact" className="max-w-6xl mx-auto px-6 py-20 mb-12">
          <div className="backdrop-blur-sm bg-white/5 border border-white/10 rounded-2xl p-12 hover:border-blue-500/50 transition-all duration-500">
            ...
            <p className="mt-8 text-gray-400 text-sm">Business inquiries, collaborations, or just want to say what's up? Send me an email and I'll get back to you ASAP.</p>
          </div>
        </section>
      ...
      <style>{`@keyframes fade-in{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}.animate-fade-in{animation:fade-in 1s ease-out}`}</style>
    </div>
  );
}
